...
# source: sample_complex_message.proto
...
ComplexMessage = _reflection.GeneratedProtocolMessageType('ComplexMessage', (_message.Message,), dict(
  ...
  __module__ = 'sample_complex_message_pb2'
